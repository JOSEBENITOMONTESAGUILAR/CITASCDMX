...
class ApiController extends Controller
{
    ...
    public function getFechas($id_modulo, $terminacion = null){
        $dias = $this->generarDiasDisponibles($id_modulo);
        return $this->showMessage($dias,200);
    }

    public function getHorarios($id_modulo, $terminacion = null){
        $horarios = $this->generarHorariosDisponibles($id_modulo);
        return $this->showMessage($horarios,200);
    }

    public function getCitaFinal($dia,$id_modulo,$terminacion = null){
